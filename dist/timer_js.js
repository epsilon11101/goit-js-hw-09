...
// EXTERNAL MODULE: ./node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js
var notiflix_aio_3_2_5_min = __webpack_require__(533);
var notiflix_aio_3_2_5_min_default = /*#__PURE__*/__webpack_require__.n(notiflix_aio_3_2_5_min);
;// CONCATENATED MODULE: ./src/js/02-timer.js





var date_picker = document.getElementById("datetime-picker");
...
function getMS(today, future) {
  var days = future.getDate() - today.getDate();
  var actualSeconds = today.getHours() * 3600 + today.getMinutes() * 60;
  var seconds = days * 24 * 3600 - actualSeconds;
  return seconds * 1000;
}
function setNumberDate(str) {
  return str.toString().length < 2 ? "0".concat(str) : str;
}
function timer_counter() {
  var timer = setInterval(function () {
    var count_down = convertMs(_ms -= 1000);
...
var options = {
  ...
  onClose: function onClose(selectedDates) {
    ...
    if (date - today > 0) {
      ...
      timer_counter(_ms);
      notiflix_aio_3_2_5_min_default().Notify.success("Nice date dude!!");
    } else {
      notiflix_aio_3_2_5_min_default().Notify.failure("Please choose a date in the future");
    }
  }
};
esm(date_picker, options);
})();
